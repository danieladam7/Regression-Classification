# -*- coding: utf-8 -*-
"""Regression_Classification_.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1UFvfrHCQTNsuw29V679lZ9OuS3dhQ4eM
...
raw_data = pd.read_pickle('/content/Abstract continuous data.pickle')
print(raw_data)
...
"""####**4.3) Evaluation of models on dev-set**"""
...
print(f"MSE: {dev_results[4]['MSE']}")
print(f"MAE: {dev_results[4]['MAE']}")
print(f"R2 Score: {dev_results[4]['R2']} \n")
...
> With an MSE value of 0.2351, MSA value of 0.3197 and R2-score of 0.8314 we got overall a got perfromance of the XGB Regressor on new, unseen data.
